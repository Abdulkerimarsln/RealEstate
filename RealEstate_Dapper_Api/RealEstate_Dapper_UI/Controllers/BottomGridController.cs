...
namespace RealEstate_Dapper_UI.Controllers
{
    public class BottomGridController : Controller
    {
        ...
        [HttpGet]
        public IActionResult CreateBottomGridDetail()
        {
            return View();
        }
        [HttpPost]
        public async Task<IActionResult> CreateBottomGridDetail(CreateBottomGridDto createBottomGridDetailDto)
        {
            var client = _httpClientFactory.CreateClient();
            var jsonData = JsonConvert.SerializeObject(createBottomGridDetailDto);
        ...
        public async Task<IActionResult> DeleteBottomGridDetail(int id)
        {
            var client = _httpClientFactory.CreateClient();
        ...
        [HttpGet]
        public async Task<IActionResult> UpdateBottomGridDetail(int id)
        {
            var client = _httpClientFactory.CreateClient();
        ...
        [HttpPost]
        public async Task<IActionResult> UpdateBottomGridDetail(UpdateBottomGridDto updateBottomGridDetailDto)
        {
            var client = _httpClientFactory.CreateClient();
            var jsonData = JsonConvert.SerializeObject(updateBottomGridDetailDto);
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
